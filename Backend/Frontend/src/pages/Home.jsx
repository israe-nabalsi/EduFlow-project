        ...
        <section className="dashboard-card quick-actions-card">
          ...
          <div className="card-content">
            <div className="quick-actions-grid">
              <button className="quick-action-btn" onClick={() => handleQuickAction('courses')}>
                <FaBookOpen />
                <span>View Courses</span>
              </button>
              <button className="quick-action-btn" onClick={() => handleQuickAction('tasks')}>
                <FaTasks />
                <span>Manage Tasks</span>
              </button>
              <button className="quick-action-btn" onClick={() => handleQuickAction('exams')}>
                <FaGraduationCap />
                <span>Upcoming Exams</span>
              </button>
              <button className="quick-action-btn" onClick={() => handleQuickAction('grades')}>
                <FaChartLine />
